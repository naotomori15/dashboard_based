...
export default function PropertiDetails() {
  ...
  const productsDetails = data?.data ?? {};
  const isCurrentUser = user?.email === productsDetails?.creator?.email;
          ...
          <Box
            ...
            <Stack
              ...
              <Stack
                ...
                <img
                  src={
                    checkImage(productsDetails.creator.avatar)
                      ? productsDetails.creator.avatar
                      : 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png'
                  }
                  alt={productsDetails.creator.name}
                  width={90}
                  height={90}
                ...
                <Typography
                  ...
                  fontWeight={600}
                  color='#11142D'>
                  {productsDetails.creator.allProducts.length} Products
                </Typography>
              </Stack>
              <Stack
                width='100%'
                ...
                <CustomButton
                  ...
                  handleClick={() => {
                    if (isCurrentUser) {
                      navigate(`/products/edit/${productsDetails._id}`);
                    }
                  }}
                />
                <CustomButton
